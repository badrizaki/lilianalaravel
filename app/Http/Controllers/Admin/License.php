...
class License extends BaseController
{
    ...
    protected $redirectTo = 'license'; // REDIRECT URL
    protected $redirectIndex = 'license.index'; // View index
    protected $redirectEditable = 'license.editable'; // vied add and update
    protected $redirectShow = 'license.show'; // vied add and update
    ...
    */
    ...
    {
        $list = [];
        $list['license'] = \App\Models\TextBank::where('key', 'license')->get()->first();
        return $list;
    }
    ...
    */
    protected function listAjax()
    {
        ...
        return Datatables::of($item)
            ...
            {
                $action = '';
                $action .= '<a href="'.route('license.index').'/'.$item->licenseId.'/edit" class="btn btn-xs btn-primary"><i class="'.$this->icon['tables']['edit'].'"></i> Edit</a>&nbsp;&nbsp;&nbsp;';
                // $action .= '<a href="'.route('license.index').'/'.$item->licenseId.'" class="btn btn-xs btn-primary"><i class="'.$this->icon['tables']['detail'].'"></i> Detail</a>&nbsp;&nbsp;&nbsp;';
                $action .= '<a href="#" class="btn btn-xs btn-primary" onClick="listManager.delete(\''.$item->licenseId.'\')"><i class="'.$this->icon['tables']['delete'].'"></i> Delete</a>';
                return $action;
            })
            ->editColumn('id', 'ID: {{$licenseId}}')
    ...
    {
        return \App\Models\License::find($id);
    }
    ...
    public function storeMain(Request $request)
    {
        ...
        $item = \App\Models\TextBank::where('key', 'license')->update($data);
