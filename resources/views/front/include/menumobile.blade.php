<div id="navbarSupportedContent">
   <ul class="main-menu nav flex-column">
      ...
      <li class="nav-item"> 
         <a class="nav-link collapsed" href="#profile" data-toggle="collapse" data-target="#mobile-profile" aria-expanded="true">
            <span>{{ getTextLang(GetData::textBank()->profile['menu'], GetData::textBank()->profile['menuInd']) }}</span>
         </a>
         <div class="collapse sub-item" id="mobile-profile" aria-expanded="true">
      ...
      <li class="nav-item"> 
         <a class="nav-link collapsed" href="#financialServices" data-toggle="collapse" data-target="#mobile-financialServices" aria-expanded="true">
            <span>{{ getTextLang(GetData::textBank()->financialServices['menu'], GetData::textBank()->financialServices['menuInd']) }}</span>
         </a>
         <div class="collapse sub-item" id="mobile-financialServices" aria-expanded="true">
            <ul class="flex-column nav">
               <li class="nav-item">
      ...
      <li class="nav-item"> 
         <a class="nav-link collapsed" href="#gcc" data-toggle="collapse" data-target="#mobile-gcc" aria-expanded="true">
            <span>{{ getTextLang(GetData::textBank()->gcc['menu'], GetData::textBank()->gcc['menuInd']) }}</span>
         </a>
         <div class="collapse sub-item" id="mobile-gcc" aria-expanded="true">
            <ul class="flex-column nav">
               <li class="nav-item">
               ...
               <li class="nav-item">
                  <a class="nav-link py-0" href="{{ url('sustainability-report#container-main-content') }}#container-main-content">
      ...
      <li class="nav-item"> 
         <a class="nav-link collapsed" href="#investorRelations" data-toggle="collapse" data-target="#mobile-investorRelations" aria-expanded="true">
            <span>{{ getTextLang(GetData::textBank()->investorRelations['menu'], GetData::textBank()->investorRelations['menuInd']) }}</span>
         </a>
         <div class="collapse sub-item" id="mobile-investorRelations" aria-expanded="true">
            <ul class="flex-column nav">
               <li class="nav-item">
      ...
      <li class="nav-item"> 
         <a class="nav-link collapsed" href="#researchAndNews" data-toggle="collapse" data-target="#mobile-researchAndNews" aria-expanded="true">
            <span>{{ getTextLang(GetData::textBank()->researchAndNews['menu'], GetData::textBank()->researchAndNews['menuInd']) }}</span>
         </a>
         <div class="collapse sub-item" id="mobile-researchAndNews" aria-expanded="true">
            <ul class="flex-column nav">
               <li class="nav-item">
