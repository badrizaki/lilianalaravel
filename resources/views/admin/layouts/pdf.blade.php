...
<head>
  ...
  <style type="text/css">
    ...
    body, #bodyTable, #bodyCell, #bodyCell{height:100% !important; margin:0; padding:0; width:100% !important;}
    ...
    h1, h2, h3, h4, h5, h6{color:#5F5F5F; font-weight:normal; font-size:20px; line-height:125%; text-align:Left; letter-spacing:normal;margin-top:0;margin-right:0;margin-bottom:10px;margin-left:0;padding-top:0;padding-bottom:0;padding-left:0;padding-right:0;}
    ...
    .buttonContent{color:#FFFFFF; font-size:18px; font-weight:bold; line-height:100%; padding:15px; text-align:center; background-color: #40DEDF;}
    .btn{color:#FFFFFF; font-size:18px; font-weight:bold; padding:15px; text-align:center; background-color: #40DEDF;}
...
<body bgcolor="#ffffff" leftmargin="0" marginwidth="0" topmargin="0" marginheight="10px" offset="0">
  <center>
    <div style="padding: 20px;">
      <table class="container" border="0" cellpadding="30" cellspacing="30" height="100%" style="table-layout: fixed; border: 1px solid #d0d2d3; box-shadow: 0 .5rem 1rem rgba(0,0,0,.15) !important; width: 100%; max-width: 550px; padding: 50px; font-family: 'blogger_sansregular',Arial,sans-serif;">
        <tr>
          <td align="left" valign="top">
          </td>
        </tr>
        <tr>
          <td valign="top" width="100%" style="padding: 50px;padding-top: 0; margin-top: 0;">
            <div><img src="{{ base_path() }}\..\public\assets\front\img\logo-right-text.png" width="700px">
              <!-- <a href="{{ url('') }}"><img src="{{ base_path() }}\..\public\assets\front\img\logo-right-text.png" width="700px"></a> -->
              <!-- <a href="{{ url('') }}"><img src="{{ url('assets/front/img/logo-right-text.png') }}" width="200px"></a> -->
            </div>
            <div style="text-align:left;font-size:14pt;margin-bottom:0;color:#5F5F5F;line-height:135%;">
              @yield('content')
            </div>
          </td>
        </tr>
