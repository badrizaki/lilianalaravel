...
<head>
  ...
  <style type="text/css">
    ...
    table[class=table-blue] thead th,
    .table-blue thead th {
      padding-top: 10px;
      padding-bottom: 10px;
    }

    table[class=table-blue] tbody td,
    .table-blue tbody td {
      border: 1px solid #ffffff;
      padding: 10px;
    }
...
<body bgcolor="#ffffff" leftmargin="0" marginwidth="0" topmargin="0" marginheight="10px" offset="0">
  <center>
    <div style="padding: 20px;">
      <table class="container" border="0" cellpadding="30" cellspacing="30" height="100%"
        style="table-layout: fixed; border: 1px solid #d0d2d3; box-shadow: 0 .5rem 1rem rgba(0,0,0,.15) !important; width: 100%; max-width: 550px; padding: 50px; font-family: 'blogger_sansregular',Arial,sans-serif;">
        <tr>
